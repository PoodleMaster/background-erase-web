...
function ResultImgLoadWait() {
  document
    ...
    .removeEventListener("load", ResultImgLoadWait);
  document
    .getElementById("ResultImg")
    .addEventListener("load", ResultImgLoadResult);
...
function ResultImgLoadResult() {
  document
    .getElementById("ResultImg")
    .removeEventListener("load", ResultImgLoadResult);
  document
    .getElementById("ResultImg")
    .addEventListener("load", ResultImgLoadWait);
