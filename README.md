...
- example：{Heroku AppName} is `app-bge-web`.
```
sudo heroku container:login
sudo heroku create app-bge-web
sudo heroku container:push web -a app-bge-web
sudo heroku container:release web -a app-bge-web
```

## (4)：Heroku Log
How to browse Heroku Log.
```
sudo heroku logs --tail -a app-bge-web
```
